...
function setup() {
  ...
  for (let i = -20; i < 20; ++i) {
    temp.set([i,i],[new Pheromone("Pain. 2x",100,100,0.25,0.01)],true);
    temp.set([-i,i],[new Pheromone("Pain.",100,100,0.25,0.01)],true);
  }
  temp.set([0,0],[new Pheromone("Pain. 3x",100,100,0.25,0.005)],true);
