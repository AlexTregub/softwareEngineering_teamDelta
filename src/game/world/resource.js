...
function registerAllResourceTypes() {
  ...
  g_resourceManager.registerResourceType('greenLeaf', {
    imagePath: 'assets/images/sprites/resources/leaf.png',
    weight: 0.5,
    canBePickedUp: true,
  ...
  g_resourceManager.registerResourceType('mapleLeaf', {
    imagePath: 'assets/images/sprites/resources/mapleLeaf.png',
    weight: 0.8,
    canBePickedUp: true,
    size: { width: 20, height: 20 },
  ...
  g_resourceManager.registerResourceType('stick', {
    imagePath: 'assets/images/sprites/resources/stick.png',
    weight: 0.6,
    canBePickedUp: true,
  ...
  g_resourceManager.registerResourceType('stone', {
    imagePath: 'assets/images/sprites/resources/stone.png',
