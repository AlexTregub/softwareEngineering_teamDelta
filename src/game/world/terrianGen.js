...
function terrainPreloader(){
  GRASS_IMAGE = loadImage('assets/images/tiles/16x16/grass.png');
  DIRT_IMAGE = loadImage('assets/images/tiles/16x16/dirt.png');
  STONE_IMAGE = loadImage('assets/images/tiles/16x16/stone.png');
  MOSS_IMAGE = loadImage('assets/images/tiles/16x16/moss.png');
}
